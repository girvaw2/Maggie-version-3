...
//   private_handle.param("max_solver_iterations", max_iterations, 5000);
//   private_handle.param("max_search_iterations", max_search_iterations_, 30);
                                           ...
                                           int &error_code)
{
  ...
  srv.request.manip_name = "rightarm";
  ...
  srv.request.iktype = "Transform6D";
